<!-- 
    File: pages/apni-duniya/index.php
    Author: Yash Balotiya
    Description: This file contains the apni-duniya page of the website.
...
<head>
    <!-- Tab Details -->
    <title>SAI NGO | Other Projects</title>
            ...
            <div class="accordion" id="accordionExample">
                <div class="accordion-item">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            ...
                            <p>There are few people who are living singly & their children away from them will be provided homely atmosphere & taken care of.</p>

                            <ul>
                                <li>Hospice for treatment of beneficiaries & surrounded tribal community- This will admit those patients who are chronically ill, or those patients with HIV/AIDS or T.B. and Cancer who need hospitalization. They will be given nutrition, and all the medicines as and when required.</li>
                            </ul>

                            <br>

                            <p>Some patients who are terminally ill and breathing their last is usually turned away from hospitals. These patients can be admitted to the hospice where they can receive medications and extends their life. But those who cannot be saved can at least die peacefully and with dignity.</p>

                            <p>Our land is surrounded by tribal community who are socially & economically backward hence as our social obligation we shall provide the facilities of medication & job opportunities.</p>

                            <ul>
                                <li>Rehabilitation & Vocational Training Centre- For this the center will provide vocational training in developing skills and entrepreneurship to beneficiaries , so they get an alternative source of livelihood and they become models for others to progress.</li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <div>
                                <img src="../../assets/images/Aids-360x300.png" alt="AIDS">
                            </div>

                            <h3>AIDS Project</h3>
                            <p>November 18, 2017 - Admin</p>

                            <p>2.10 million people & more suffer from HIV in India-</p>
                            <p>(Sources- National AIDS Control Organisation (NACO)- India)</p>
                            <p>But</p>
                            <p>Unlike other sicknesses & diseases, these unfortunate victims are shunned & ostracized & made to suffer double for something which quite often they got for no fault of their own…</p>
                            <p>“Services offered by…… is to be changed as “Services provided by Social Activities Integration-SAI” –( however the existing information of services shall continue without any change as per our existing website.</p>

                            <br>

                            <p>The existing Project at Social Activities Integration –SAI is to be replaced as shown under: & the project information for each project shall continue with existing information as per our existing website. For the below project we will incorporate the information afterward.</p>

                            <br>

                            <p>Since 1991 we have been combating AIDS vigorously with involving high risk population by carrying out various project activities as shown herebelow.</p>

                            <br>

                            <p><b><u>Past project-</u></b></p>
                            <ol>
                                <li>Suraksha</li>
                                <li>Prevention of Parents to Child Transmission (PPTCT)</li>
                                <li>Pediatric AIDS Initiative (PAI)</li>
                                <li>Community Care Centre (CCC)</li>
                                <li>Mobile ICTC in Thane district</li>
                            </ol>

                            <br>

                            <p><b><u>Current Projects-</u></b></p>
                            <ol>
                                <li>Awareness project</li>
                                <li>Didi Project</li>
                                <li>Free mobile & Static Clinic</li>
                                <li>Drop In Center</li>
                                <li>Vihaan- Care & Support Centres</li>
                                <li>Pahal on Hepatitis B</li>
                                <li>REAR- Reach for Education and Access to Rights</li>
                            </ol>
                        </div>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <div>
                                <img src="../../assets/images/cancer-360x300.png" alt="">
                            </div>
